...
Use this when publishing Nous publicly. The goal is simple: make people understand the project in one sentence, see the difference in one demo, and know exactly where to click next.
...
Nous is a local-first epistemic substrate for AI systems that use language models. Instead of storing just chunks or chat history, it stores typed relations with evidence and uncertainty, so the model can answer with a grounded context block instead of bluffing through missing knowledge.
...
Nous is a local-first epistemic substrate that knows:
...
Repo: [github.com/base76-research-lab/Nous](https://github.com/base76-research-lab/Nous)
...
1. Nous takes a different route.
...
1. Repo: [github.com/base76-research-lab/Nous](https://github.com/base76-research-lab/Nous)
PyPI: [pypi.org/project/nouse](https://pypi.org/project/nouse/)
...
PyPI: [pypi.org/project/nouse](https://pypi.org/project/nouse/)
GitHub: [github.com/base76-research-lab/Nous](https://github.com/base76-research-lab/Nous)

I think this is a more useful direction for agents than “just add more context.”

## Hacker News Titles

- Show HN: Nous, structured memory for LLM agents
- Show HN: Nous gives LLM agents confidence-aware memory
...
- Nous is not trying to replace the model
