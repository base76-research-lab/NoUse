...
#### Fix #26 — MCP web search provider routing ([PR #33](https://github.com/base76-research-lab/Nous/pull/33), [Issue #26](https://github.com/base76-research-lab/Nous/issues/26))
...
#### Fix #25 — HITL low-risk auto-approve guards ([PR #34](https://github.com/base76-research-lab/Nous/pull/34), [Issue #25](https://github.com/base76-research-lab/Nous/issues/25))
...
#### Fix #27 — Graph center state API/client alignment ([PR #35](https://github.com/base76-research-lab/Nous/pull/35), [Issue #27](https://github.com/base76-research-lab/Nous/issues/27))
...
#### Fix #28 — Insights extraction + recent API ([PR #36](https://github.com/base76-research-lab/Nous/pull/36), [Issue #28](https://github.com/base76-research-lab/Nous/issues/28))
...
#### Fix #29 — Reusable Nous-first LLM wrapper ([PR #37](https://github.com/base76-research-lab/Nous/pull/37), [Issue #29](https://github.com/base76-research-lab/Nous/issues/29))
- Added reusable wrapper for grounded system prompt construction from Nous memory.
...
#### Fix #30 — Provider/model-ref policy hardening ([PR #38](https://github.com/base76-research-lab/Nous/pull/38), [Issue #30](https://github.com/base76-research-lab/Nous/issues/30))
